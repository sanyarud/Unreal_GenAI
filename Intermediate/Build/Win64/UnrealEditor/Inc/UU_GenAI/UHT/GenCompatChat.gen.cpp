...
struct Z_Construct_UClass_UGenDeepSeekChatAsync_Statics
{
	...
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UGenDeepSeekChatAsync_RequestDeepSeekChatCompletion, "RequestDeepSeekChatCompletion" }, // 1477612286
	};
...
struct Z_Construct_UClass_UGenMistralChatAsync_Statics
{
	...
	static UObject* (*const DependentSingletons[])();
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UGenMistralChatAsync_RequestMistralChatCompletion, "RequestMistralChatCompletion" }, // 928003583
	};
	static_assert(UE_ARRAY_COUNT(FuncInfo) < 2048);
	static constexpr FCppClassTypeInfoStatic StaticCppClassTypeInfo = {
...
struct Z_Construct_UClass_UGenCompatChatAsync_Statics
{
	...
	static UObject* (*const DependentSingletons[])();
	static constexpr FClassFunctionLinkInfo FuncInfo[] = {
		{ &Z_Construct_UFunction_UGenCompatChatAsync_RequestCompatChatCompletion, "RequestCompatChatCompletion" }, // 2575572029
	};
	static_assert(UE_ARRAY_COUNT(FuncInfo) < 2048);
	static constexpr FCppClassTypeInfoStatic StaticCppClassTypeInfo = {
...
struct Z_CompiledInDeferFile_FID_The_Rebirth_Fight_Plugins_UU_GenAI_Source_UU_GenAI_Public_Compat_GenCompatChat_h__Script_UU_GenAI_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UGenDeepSeekChatAsync, UGenDeepSeekChatAsync::StaticClass, TEXT("UGenDeepSeekChatAsync"), &Z_Registration_Info_UClass_UGenDeepSeekChatAsync, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGenDeepSeekChatAsync), 3256624525U) },
		{ Z_Construct_UClass_UGenMistralChatAsync, UGenMistralChatAsync::StaticClass, TEXT("UGenMistralChatAsync"), &Z_Registration_Info_UClass_UGenMistralChatAsync, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGenMistralChatAsync), 4182544833U) },
		{ Z_Construct_UClass_UGenCompatChatAsync, UGenCompatChatAsync::StaticClass, TEXT("UGenCompatChatAsync"), &Z_Registration_Info_UClass_UGenCompatChatAsync, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UGenCompatChatAsync), 963633761U) },
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_The_Rebirth_Fight_Plugins_UU_GenAI_Source_UU_GenAI_Public_Compat_GenCompatChat_h__Script_UU_GenAI_2310489657(TEXT("/Script/UU_GenAI"),
